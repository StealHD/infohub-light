...
import {openclawServerEntries} from './openclawServerEntry';import {stableAsyncButtonChangelogEntry} from './stableAsyncButtonChangelogEntry';import {agentWorkspaceChangelogEntry} from './agentWorkspaceChangelogEntry';import {automationUiPolishEntry} from './automationUiPolishEntry'
export const changelogMonths:import('./changelogTypes').ChangelogMonth[]=[{id:'month-2026-09',label:'2026 年 9 月',entries:[automationUiPolishEntry,openclawRoleSessionEntry,sourceIdentityRecoveryEntry,openclawModelRecoveryEntry,automationRecoveryEntry,automationLayoutEntry,composerPanelEntry,automationsUnifiedEntry,...openclawServerEntries,agentWorkspaceChangelogEntry,stableAsyncButtonChangelogEntry]}, {
