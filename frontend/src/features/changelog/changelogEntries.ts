    ...
    entries: [
      {
        ...
        items: [
          ...
          { title: '单个合格候选不会被空搜索清掉', description: '兼容流程会跨免费搜索保留同一路线中每个 Actor 的最新安全证据；后续搜索没有新增候选时，已合格的 1 个 Actor 仍可进入 Canary，不需要反复搜索。Actor 的 Build、Schema、价格或失败指纹变化后仍会重新判定。' },
