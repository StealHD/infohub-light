// Reviewed: verified-only ActorOps catalog, revision-aware current-source proofs, verified-pool activation, bounded stale-circuit source Canary recovery, and no-charge pre-execution recovery.
