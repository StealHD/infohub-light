// Reviewed: verified-only ActorOps catalog, revision-aware current-source proofs, immediate bounded stale-circuit source Canary recovery, and no-charge pre-execution recovery.
