    ...
    entries: [
      {
        date: '2026-08-09',
        title: '信息流新增专题速览阅读模式',
        summary: '信息流可通过搜索前的轻量图标切换时间流与专题速览；专题默认收起，展开后可在来源分组卡片内连续阅读近期更新。',
        items: [
          { title: '按来源连续快速阅读', description: '专题速览在当前近 N 天窗口、搜索外的筛选结果和现有排序基础上按来源分组；来源按最近发布时间排序，组内继续沿用你的文章顺序，不会把多来源合并内容重复显示。' },
          { title: '专题信息更容易扫读', description: '每个来源以一张克制的分组卡片显示头像、名称、当前文章数、去重主题数与最多三个高频主题；初次进入全部收起，一次仅展开一个专题。文章仍是组内紧凑行，不会变成大卡片套小卡片。' },
          { title: '现有阅读功能完全复用', description: '展开、媒体预览、原文、收藏、忽略、Agent 上下文、阅读状态和权限保持原有行为；来源标题支持键盘展开。模式按账户隔离保存在浏览器中；搜索时暂时固定时间流，清空后自动恢复专题与阅读位置。信息概览打开时专题阅读列会同步避让，时间流和专题速览都保持独立顺畅滚动，触底文案在停留底部时保持稳定。' },
        ],
      },
      {
        date: '2026-08-08',
