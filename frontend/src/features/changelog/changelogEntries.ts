...
import { codeHealthMaintenanceEntry, feedSourceLabelChangelogEntry, instagramSourceAvatarChangelogEntry, pageHeaderChangelogEntry, sourceFetchPreflightChangelogEntry, subscriptionCommandBarChangelogEntry, systemSettingsChangelogEntry } from './maintenanceChangelogEntries'
...
export const changelogMonths: ChangelogMonth[] = [
  {
    id: 'month-2026-08',
    label: '2026 年 8 月',
    entries: [sourceFetchPreflightChangelogEntry, feedSourceLabelChangelogEntry, instagramSourceAvatarChangelogEntry, systemSettingsChangelogEntry,
