    ...
    entries: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: '失败会被记住', description: '同一 Actor 与 Build/Schema/价格指纹的确定性失败不会反复进入 AI 或付费计划；只有证据变化才会重新评估。已知中断 Run 只免费核对原状态；若已终态失败，系统仅在证明版本号由中断保护步骤改变后继续同一审批中尚未运行的候选，不会重发失败 Actor 或跨越真实配置变更。' },
