// Reviewed: verified-only ActorOps catalog, revision-aware current-source proofs, verified-pool activation, source-proof circuit recovery, and no-charge pre-execution recovery.
