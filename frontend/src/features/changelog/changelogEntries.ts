...
import {openclawRoleSessionEntry} from './openclawRoleSessionEntry';import {sourceIdentityRecoveryEntry} from './sourceIdentityRecoveryEntry';import {telegramTopicsOpenclawNotificationEntry} from './telegramTopicsOpenclawNotificationEntry'
...
export const changelogMonths:import('./changelogTypes').ChangelogMonth[]=[{id:'month-2026-09',label:'2026 年 9 月',entries:[telegramTopicsOpenclawNotificationEntry,openclawRoleSessionEntry,sourceIdentityRecoveryEntry,openclawModelRecoveryEntry,automationRecoveryEntry,automationLayoutEntry,composerPanelEntry,automationsUnifiedEntry,...openclawServerEntries,agentWorkspaceChangelogEntry,stableAsyncButtonChangelogEntry]}, {
