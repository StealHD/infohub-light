...
export const changelogMonths: ChangelogMonth[] = [
  {
    ...
    entries: [
      {
        date: '2026-07-26',
        title: '订阅操作更紧凑，RSS 首次窗口可选',
        summary: '订阅卡片减少跳动与层级，异常来源更容易定位，新 RSS 可选择获取 7 天或 30 天历史。',
        items: [
          { title: '全部与异常视图', description: '我的订阅默认显示“全部”，并固定提供只包含需关注与连续失败的“异常”；即使暂时为零也可直接进入，移动端保持一致。' },
          { title: '分享、编辑与通知直达', description: '分享和编辑成为带说明的卡片图标；新内容通知也直接在卡片切换，失败会恢复原状态，设置弹窗不再重复覆盖通知选择。' },
          ...
          { title: '状态对齐', description: '来源健康标签、标题和右侧操作统一垂直中心线，OpenClaw 的连接与工具状态也使用同一局部对齐容器。' },
        ],
      },
      {
        date: '2026-07-26',
