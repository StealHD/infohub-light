    ...
    entries: [
      {
        date: '2026-08-09',
        title: '信息流新增专题速览阅读模式',
        summary: '信息流可在时间流和专题速览之间切换，同一来源的近期更新会连续呈现，方便在几十秒内掌握一个专题。',
        items: [
          { title: '按来源连续快速阅读', description: '专题速览在当前近 N 天窗口、搜索外的筛选结果和现有排序基础上按来源分组；来源按最近发布时间排序，组内继续沿用你的文章顺序，不会把多来源合并内容重复显示。' },
          { title: '专题信息更容易扫读', description: '每个来源区显示头像、名称、当前文章数、去重主题数与最多三个高频主题；文章保持紧凑标题、摘要、时间和主题信息，不使用大面积卡片。' },
          { title: '现有阅读功能完全复用', description: '展开、媒体预览、原文、收藏、忽略、Agent 上下文、阅读状态和权限保持原有行为。模式按账户隔离保存在浏览器中；搜索时暂时固定时间流，清空后自动恢复。' },
        ],
      },
      {
        date: '2026-08-08',
