    ...
    entries: [
      {
        date: '2026-08-07',
        title: '订阅工具栏会随滚动聚焦',
        summary: '订阅列表取消固定视图，搜索、筛选和新增来源在顶部保持同一操作面，并会随滚动收为透明胶囊，状态统计继续留在卡片右上。',
        items: [
          { title: '筛选取代订阅视图', description: '“我的订阅”直接显示完整列表；需处理、公共和私人改由筛选完成，来源库继续按真实频道浏览。' },
          { title: '透明顶部工具栏', description: '页面顶部移除说明文字；工具栏与来源卡对齐，滚动后平滑收为居中胶囊。页签左侧保留，搜索居中，筛选和带文字的新增来源紧邻右侧；运行记录不显示来源工具。' },
