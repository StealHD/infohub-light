import { automationLayoutEntry } from './automationLayoutEntry'; import { composerPanelEntry } from './composerPanelEntry'; import { automationsUnifiedEntry } from './automationsUnifiedEntry'; import { actorOpsV2AdminChangelogEntries } from './actorOpsV2AdminChangelogEntry'
...
export const changelogMonths: import('./changelogTypes').ChangelogMonth[] = [{ id: 'month-2026-09', label: '2026 年 9 月', entries: [automationLayoutEntry, composerPanelEntry, automationsUnifiedEntry, ...openclawServerEntries, agentWorkspaceChangelogEntry, stableAsyncButtonChangelogEntry] }, {
    id: 'month-2026-08',
    label: '2026 年 8 月',
