...
export const openclawServerEntries: ChangelogEntry[] = [{
  date: '2026-09-17', title: 'Agent 进阶建议升级',
  summary: '空对话提供立体分析卡片：独立底纹随光显现，背景光随卡片轮换，选择后可编辑完整问题。',
  items: [{ title: '结合证据的进阶任务', description: '建议覆盖采集链路排查、近期信号研判和订阅组合优化；带专题或已选内容时提供对应的深入分析任务。竖向卡片采用透视层级、柔和光影和自动轮换，悬停或聚焦时暂停；移除底部分页栏，可点击露出的侧卡、滑动或按方向键切换，点击当前卡片填入问题。' },
    { title: '回复按 Markdown 排版', description: 'Agent 回复中的标题、强调、列表、代码和表格按格式显示；只允许安全的网页链接，原始 HTML 和远程图片不执行或加载。' }],
}, {
  date: '2026-09-16', title: '助手连接页更清晰',
  summary: '统一展示个人 Agent 接入与成员审批，移除外部 MCP 连接入口。',
  items: [{ title: '接入与审批各有入口', description: '管理员页签改为紧凑宽度，并说明个人接入与成员审批的用途；个人状态明确提示聊天需要进入 OpenClaw 后连接。' },
    { title: '个人接入状态更紧凑', description: '卡片突出接入状态和进入 OpenClaw 操作，进入、修复与解除操作并排，刷新置于状态旁；不再展示外部 MCP 创建及命令。' }],
}, {
