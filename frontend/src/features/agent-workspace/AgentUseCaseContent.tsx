const examples = [
  { title: '快捷输入：@ 与 /', steps: '输入 @ 选择 Skill 或材料，输入 / 打开快捷菜单。菜单使用选择技能、新建对话、选择模型等名称，帮助保留 /help 提示。上下键选择，Enter 确认，Esc 关闭。', result: '操作在输入框上方的临时面板完成，关闭后不留在聊天记录中。选 Skill 不发送，点击发送才核验并调用；来源快照禁止同时调用 Skill。' },
