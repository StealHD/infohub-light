...
export const manualReview = {
  ...
  change: '公开 YouTube 频道、近 N 天信息流、安全存储与卡片图片预览',
} as const
...
export const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: '直接操作与稳定获取状态',
        description: '允许编辑的来源会在卡片下方紧凑控制行显示 Pencil 图标，和通知、订阅设置、立即获取放在同一操作区；卡片标题区只保留来源身份与健康状态。私人来源所有者会在同一行直接看到“分享来源”，无需再打开只有一个动作的“更多”；关闭或完成分享后焦点回到该按钮。来源主计数是“今日 / 近N天 / 历史”，历史大于零时可直接打开该来源的历史内容；“上次抓取”只放在更新时间和立即获取的说明中，不再冒充可见数量。移动端计数与操作会按宽度重排且不横向滚动。“立即获取”在提交、排队和运行期间保持同一宽度与文字，只旋转图标并阻止重复点击。',
      },
      {
        title: '排查失败',
