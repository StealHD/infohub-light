...
export const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: '启动、暂停与删除自动化',
        description: '任务列表右侧的播放或暂停图标可直接启动完整且已保存的任务，或暂停运行中的任务；鼠标停留及键盘聚焦图标会显示说明。新建草稿、已启用、已暂停或已归档任务都可点击删除图标，经确认后从列表移除并停止后续处理。删除不会清除已有运行与投递回执，也不能撤销；编辑中有未保存修改时，先保存或放弃修改。',
        href: '/agent/automations', linkLabel: '打开自动化',
      },
      {
