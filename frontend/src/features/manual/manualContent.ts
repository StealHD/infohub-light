// Reviewed for ActorOps exact-revision rejection, broader discovery, per-revision mapping, metadata-row handling, and cost-cap migration controls; no user-visible release note was added.
