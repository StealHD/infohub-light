// Reviewed after the API adapter and Worker pre-claim cycle splits; user workflows are unchanged.
...
export const manualReview = {
  ...
  change: 'v2.3.2 后的代码规模、资源生命周期、API/Worker 与 Store 分层收敛；用户工作流不变',
} as const
