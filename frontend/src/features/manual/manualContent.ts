...
export const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    steps: [
      {
        title: '按频道管理',
        description: '“我的订阅”固定按“全部 → 异常 → 公共订阅 → 私人订阅”排列，默认显示全部；异常只收纳需关注与连续失败，不包含尚未抓取。四个视图即使为零也保留，数量会随搜索和筛选更新；旧 workspace 来源计入公共订阅。“来源库”仍只按真实频道分类。顶部“我的订阅 / 来源库 / 运行记录”不再长期显示数量，数量集中在信息概览；页面链接会用 tab 参数保留当前页签。“我的订阅”和“来源库”的页签行右侧可搜索全部来源，运行记录页不显示搜索。类型、健康状态和可见范围通过“筛选”下拉菜单设置，移动端选择器使用相同规则。',
      },
      {
        title: '公共与私人',
