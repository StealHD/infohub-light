...
export const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    steps: [
      {
        title: '搜索与筛选来源',
        description: '“我的订阅”不再显示独立视图，默认以完整列表显示全部订阅；通过页签工具栏的“筛选”选择“需处理”（需关注与连续失败）、公共订阅或私人订阅，旧 workspace 来源计入公共订阅。“来源库”仍只按真实频道分类。页面顶部没有说明文字；工具栏在滚动超过少量距离后会平滑收为居中的半透明胶囊，回到顶部即恢复全宽透明状态。左侧是“我的订阅 / 来源库 / 运行记录”，前两个页签在中间提供来源搜索，右侧有筛选和带完整文字的“新增来源”；运行记录不显示这些工具。手机上页签与搜索操作分两行，页面不横向滚动。页面链接会用 tab 参数保留当前页签。',
      },
      {
        title: '公共与私人',
