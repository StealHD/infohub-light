...
export const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: '只通知之后的新内容',
        description: '先在设置页分别配置邮箱、Webhook 或 Telegram，并勾选需要同时启用的渠道，再直接使用订阅卡片上的 Bell/BellRing 图标开关；鼠标停留或键盘聚焦会在上方说明当前状态，订阅设置弹窗不再重复该选项。三张渠道卡始终保留，不会因为切换渠道隐藏或清空其他配置；每张卡独立发送测试并显示自己的结果。Webhook 可选择通用事件 JSON、通用文本 JSON、飞书/Lark V2、企业微信群机器人、钉钉、Slack/GovSlack 或 Discord；Telegram 使用管理员已经测试并启用的工作区 Bot 服务，你只填写自己的 Chat ID。邮箱或 Telegram 服务暂停时只暂停对应渠道，其他渠道继续投递。首次快照、历史或复用内容、总开关/渠道/订阅任一层停用期间发现的内容都不会补推；personal_only 来源不参与通知。',
        href: '/settings',
        linkLabel: '配置消息通知',
      },
      {
