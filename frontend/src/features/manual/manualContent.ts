// Reviewed after the queued-job, Agent, member, Feed-read, and schedule API adapter splits; user workflows are unchanged.
...
export const manualReview = {
  ...
  change: 'v2.3.2 后的代码规模、资源生命周期、Jobs/Agent/成员/Feed/周期 API 与 Store 分层收敛；用户工作流不变',
} as const
