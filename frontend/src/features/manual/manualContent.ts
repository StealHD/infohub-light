...
export const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    steps: [
      {
        title: '配置个人 Agent',
        description: '在 Agent 接入页点击“接入 Agent”，由系统配置并验证本机 OpenClaw，完成后点击“进入 OpenClaw”。无需下载包、手动创建令牌或上传回执；进行中可以离开页面，回来继续查看同一次进度。失败后重试会先检查原绑定，不重复创建。Owner/Admin 可自助接入，普通成员先申请。需要重走配置流程时，点击“解除接入”并确认，等待清理完成后再重新接入；解除对所有浏览器生效，新接入创建新 Agent 和授权，旧历史及工作目录保留、不迁移旧会话。撤销后不自动恢复，已有其他手动授权不受影响。接入验证不调用模型或发送通知。',
