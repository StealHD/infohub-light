// Reviewed for ActorOps exact-revision rejection, broader discovery, per-revision mapping, and cost-cap migration controls; no user-visible release note was added.
