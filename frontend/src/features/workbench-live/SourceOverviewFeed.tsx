...
import { Button, Card, Icons, ImageGalleryModal, RefreshButton, Timeline } from '../../design-system'
...
import { SourceHeader, type SourceSummaryViewState } from './SourceOverviewHeader'
import {
    ...
    >
      <SourceHeader
        ...
        onRequestSummary={onRequestSummary ? () => {
          ...
          return onRequestSummary(section, summaryState?.status === 'success')
        } : undefined}
