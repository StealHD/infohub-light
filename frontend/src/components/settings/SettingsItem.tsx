...
export function SettingsItem({ label, description, icon, trailing, children, className = '' }: {
  label: string
  description?: string
  icon?: ReactNode
  trailing?: ReactNode
  ...
  return <div data-settings-item className={`flex min-w-0 flex-col gap-3 px-4 py-3.5 min-[640px]:flex-row min-[640px]:items-center ${className}`}>
