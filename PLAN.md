...
- 已实现但须独立批准：Feed storage v3、通知 schema v14–v16、ActorOps schema v17–v21、付费 Canary、外部 Webhook/Telegram/Email 验收。
...
| ActorOps v17–v21 | 无 Discovery/Canary Job | 同上，不联网、不调用 AI/Actor | 精确 migration checksum、完整表形状与 readiness |
