...
64. 产品文档与发布入口：新增源码受控 `/manual` 操作手册；账户菜单和独立“文档与发布”菜单均向上展开并提供操作手册、更新日志和 GitHub Release 入口。Test Gate 对每次产品代码合并强制检查手册与更新日志双源已同步复核；权威交互见 `UI_CONTRACT.md`，流程理由见 D056。
