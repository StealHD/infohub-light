...
from .actorops_v2_maintenance_routes import register_actorops_v2_maintenance_policy_routes
...
def register_actor_ops_pool_management_routes(
    ...
    register_actorops_v2_maintenance_policy_routes(app, context)
    register_actorops_v2_control_routes(app, context)
    register_actorops_v2_operator_routes(app, context)
