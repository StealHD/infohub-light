#!/usr/bin/env python3
"""Explicit offline installer for global 34 Dataset revalidation trigger."""
...
from src.storage.actorops_v2_revalidation_schema import (
...
def migrate(
    ...
    if result["status"] == "blocked":
        raise RuntimeError("API and Worker must stop before global 34 migration")
    ...
    backup = raw_backup.with_name(raw_backup.name.replace(
        "service-apify-actor-ops-v15-", "service-actorops-v2-v34-", 1
    ))
