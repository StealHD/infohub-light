#!/usr/bin/env python3
"""Install the automated Actor slot replacement ledger as global schema 25."""
...
def migrate(
    ...
    *,
    ...
    backup = raw_backup.with_name(raw_backup.name.replace(
        "service-apify-actor-ops-v15-", "service-apify-actor-auto-pool-v25-", 1
    ))
    ...
    try:
        ...
        valid = migration_marker_exists(connection) and apify_actor_auto_pool_v25_schema_shapes_valid(connection)
