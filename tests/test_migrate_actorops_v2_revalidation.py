...
from scripts.migrate_actorops_v2_revalidation import migrate
...
def test_global_34_trigger_migration_is_explicit_and_repeatable(
    tmp_path: Path,
) -> None:
    ...
    assert result["candidate_transition_trigger_replaced"] == 1
