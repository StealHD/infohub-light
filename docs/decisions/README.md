...
本目录是决策理由与兼容性取舍的唯一真源。普通任务只在需要追溯理由、状态或替代方案时读取对应记录；新增决策追加到当前 `D126–D150` 分桶，满桶后创建下一个连续分桶。
...
| D136 | Feed 专题速览采用浏览器本地双阅读布局与前端来源分组 | 2026-08-09 | [查看](records/D126-D150.md#d136) |
