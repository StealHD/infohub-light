...
```json
{
  ...
  "result": "实现 OpenClaw 安全图片对话：浏览器内图片规范化、选择/粘贴/拖放、模型能力拦截、Gateway 媒体票据恢复与共享 ImageGalleryModal；补齐本地/云端开关、Origin、CSP、密钥轮换和发布文档。",
  "status": "completed",
  "task_id": "2026-08-07-openclaw-image-chat-cloud-compatibility",
  "unresolved": [],
  "validation": [
